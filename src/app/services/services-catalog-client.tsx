              ...
              >
                ...
                <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                  <Link href={`/services/${service.id}`}>
                    <Button className="group/btn bg-violet-600 hover:bg-violet-700 text-white font-bold text-xs rounded-xl shadow-md px-5">
      ...
      <section className="py-20 lg:py-28">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-14 max-w-2xl">
            ...
            <h2 className="mt-2 font-display text-3xl font-bold text-ink dark:text-white sm:text-4xl">
              {content.processSection?.title || "How Our Dedicated Pods Build & Scale Software"}
            </h2>
