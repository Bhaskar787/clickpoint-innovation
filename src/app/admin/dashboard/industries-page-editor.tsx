    ...
    <div className="space-y-1.5">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="flex-1 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-[#0b0f19] px-3 py-2 text-xs font-mono text-slate-900 dark:text-white"
        />
        <input
          type="file"
          ref={fileInputRef}
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-violet-600 hover:bg-violet-700 disabled:opacity-50 text-white text-xs font-bold transition-all shadow-xs"
        >
      ...
      {value && (
        <div className="relative mt-2 h-24 w-40 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 bg-slate-900">
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] p-8 space-y-3">
        ...
        <p className="text-xs font-semibold text-slate-500">Loading Industries database record...</p>
      </div>
    );
  }
      ...
      {(!sectionId || sectionId === "ind-hero") && (
        <div className="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-[#131927] p-6 space-y-5">
          <div className="flex items-center gap-2 pb-3 border-b border-slate-100 dark:border-slate-800">
            ...
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">Industries Catalog Main Hero Banner</h3>
          </div>
        ...
        <div className="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-[#131927] p-6 space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 rounded-xl bg-violet-600 hover:bg-violet-700 text-white text-xs font-bold transition-all shadow-xs"
            >
            ...
            {formData.industries?.map((ind: any, idx: number) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-violet-600 bg-violet-100 dark:bg-violet-950 px-2 py-0.5 rounded">
                      Industry #{idx + 1}
                    </span>
                    <button
                      type="button"
                    ...
                    >
                      {selectedIndustryId === ind.id ? "Currently Editing Details" : "Edit Detailed View"}
                    </button>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    />
                    <span className="text-[9px] text-slate-400">Route: /industries/{ind.id}</span>
                  </div>
      ...
      {(!sectionId || sectionId === "ind-details") && (
        <div className="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-[#131927] p-6 space-y-5">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-100 dark:border-slate-800">
            ...
            <div className="flex items-center gap-2">
              <label className="text-xs font-bold text-slate-500">Select Industry to Edit:</label>
              <select
                value={selectedIndustryId}
                onChange={(e) => setSelectedIndustryId(e.target.value)}
                className="rounded-xl border border-violet-300 dark:border-violet-800 bg-violet-50/50 dark:bg-violet-950/40 px-3 py-1.5 text-xs font-bold text-violet-700 dark:text-violet-300 focus:outline-none"
              >
              ...
              <div className="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50 space-y-4">
                <div className="flex items-center justify-between">
                  <h4 className="text-xs font-bold text-slate-900 dark:text-white flex items-center gap-1.5">
                    ...
                    Step 1: Hero Banner & Cloudinary Media (<span className="text-violet-600">{currentIndustry.title}</span>)
                  </h4>
                </div>
              ...
              <div className="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-violet-600 hover:bg-violet-700 text-white text-[11px] font-bold"
                  >
              ...
              <div className="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50 space-y-4">
                <div className="flex items-center justify-between">
                  <h4 className="text-xs font-bold text-slate-900 dark:text-white flex items-center gap-1.5">
                    ...
                    Step 4: Featured Projects / Case Studies ({currentIndustry.projects?.length || 0})
                  </h4>
                  <button
                    type="button"
                    onClick={() => {
