...
export default function ContactEditor({ sectionId, onCloseSection, selectedItemId, onClearSelectedItem }: ContactEditorProps) {
  ...
  useEffect(() => {
    ...
    // mark as read when opened via notification and clear the selected id in parent
  ...
  const paginatedInquiries = filteredInquiries.slice(0, startIndex + pageSize); // Supports "See More" expansion
        ...
        <div className="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-[#131927] p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 pt-4 mt-2 border-t border-slate-200 dark:border-slate-800">
              <h4 className="text-xs font-extrabold text-violet-600 dark:text-violet-400 uppercase tracking-wider mb-3">
              ...
              <div>
                <div className="flex flex-wrap items-center justify-between gap-2 mb-3">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-blue-50 dark:bg-blue-950/60 text-blue-700 dark:text-blue-300 text-xs font-bold hover:bg-blue-100 dark:hover:bg-blue-900 transition-colors border border-blue-200 dark:border-blue-800 cursor-pointer"
                  >
                  ...
                  {(formData.formFields?.serviceOptions || DEFAULT_CONTACT_PAGE_DATA.formFields.serviceOptions).map((opt, idx) => (
                    ...
                    >
                      ...
                      <input
                        ...
                        className="flex-1 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-1.5 text-xs text-slate-900 dark:text-white font-semibold focus:border-blue-600 focus:outline-none"
                      />
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-100 dark:border-slate-800">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <select
                ...
                className="bg-slate-100 dark:bg-slate-800 border-none rounded-xl px-2 py-1 text-xs font-bold text-slate-700 dark:text-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-200">
            <div className="w-full max-w-xl bg-white dark:bg-[#131927] border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl p-6 space-y-5">
              <div className="flex items-start justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
                <div className="flex items-center gap-3">
                  <img
                    ...
                    className="h-10 w-10 rounded-full object-cover bg-slate-200 dark:bg-slate-700 ring-2 ring-blue-500/20"
                  />
                  <div>
              ...
              <div>
                ...
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-[#0b0f19] border border-slate-200/80 dark:border-slate-800 text-xs text-slate-800 dark:text-slate-200 leading-relaxed max-h-60 overflow-y-auto whitespace-pre-wrap font-medium">
